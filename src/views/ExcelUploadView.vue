      ...
      <div class="col-lg-4">
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body d-grid gap-2">
            <a href="/api/amendments/template" class="btn btn-outline-success"><i class="bi bi-download"></i> Download Template</a>
            <a href="/api/amendments/export" class="btn btn-outline-primary"><i class="bi bi-file-earmark-arrow-down"></i> Export All Data</a>
          </div>
        </div>
      </div>
    </div>
